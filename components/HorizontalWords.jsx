...
const HorizontalWords = () => {
    ...
    useEffect(() => {
        const ctx = gsap.context(() => {
            ...
            scrollTween
                ...
                .to(textRef, {
                    x: () => -(textRef.scrollWidth - window.innerWidth * 1.4),
                    ease: "none",
    ...
    const headline = "100% Offline-First • Resep Sub-Gram • Beli Putus";
        ...
        <section ref={sectionRef} className="horizontal-words-section content-section">
            ...
            <div className="horizontal-words__bottom-text">
                <div className="horizontal-words__bottom-text-l">
                    Dirancang khusus untuk UMKM dalam sektor F&amp;B.<br />
                    Nol ketergantungan internet di jam sibuk, kendali bahan baku skala gram,<br />
                    dan kepemilikan software mandiri tanpa jebakan sewa berlangganan selamanya.
                </div>
            </div>
        </section>
    );
