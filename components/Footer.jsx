...
import { SOCIAL_ICONS, WIGGLE_CONFIG, TEAM_MEMBERS } from '@/lib/data';
...
export default function Footer() {
    ...
    return (
        <div className="footer-inner" id="tim">
            <div className="footer-top">
                {/* Fondasi Bisnis */}
                <div className="footer-column">
                    <span className="footer-badge">fondasi bisnis</span>
                    <h3>Ekosistem Digital F&amp;B</h3>
                    <p style={{ fontSize: '0.85rem', color: 'rgba(255,255,255,0.7)', marginTop: '8px', lineHeight: 1.4 }}>
                        Operating System Kasir &amp; ERP Local-Edge terpadu untuk pengusaha kuliner Indonesia.
                    </p>
                </div>
                {/* Anggota Tim */}
                <div className="footer-column">
                    <span className="footer-badge">anggota tim</span>
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', marginTop: '6px' }}>
                        {TEAM_MEMBERS.map((member) => (
                            <div key={member.name} style={{ lineHeight: 1.3 }}>
                                <strong style={{ fontSize: '0.95rem', color: '#ffffff', display: 'block' }}>{member.name}</strong>
                                <span style={{ color: '#e9d5ff', fontSize: '0.8rem', fontWeight: 600 }}>{member.role}</span>
                            </div>
                        ))}
                    </div>
                </div>
                {/* Contact */}
                <div className="footer-column">
                    <span className="footer-badge">kontak &amp; diskusi</span>
                    <a href="mailto:kontak@kalibra-os.app" className="footer-email">kontak@kalibra-os.app</a>
                    <a href="https://wa.me/6281234567890" target="_blank" rel="noopener noreferrer" className="footer-whatsapp">
                        Chat WhatsApp Founder*
                    </a>
                    <p className="footer-note">*Terbuka untuk kemitraan pilot testing cafe &amp; resto.</p>
            ...
            {/* Big KALIBRA wordmark */}
            <div className="footer-bottom">
                <div className="footer-big-text">
                    <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 1200 220" fill="none" className="footer-logo__svg">
                        <text
                            x="50%"
                            y="60%"
                            textAnchor="middle"
                            ...
                            letterSpacing="-6"
                        >
                            KALIBRA<tspan fill="#8b5cf6">.OS</tspan>
                        </text>
                    </svg>
                </div>
                ...
                <div className="footer-bottom-row">
                    ...
                    <div className="footer-credits-wrapper">
                        <div className="credits-box">
                            <div className="credits-content" style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '12px 24px', minWidth: '360px' }}>
                                {TEAM_MEMBERS.map((m) => (
                                    <div key={m.name} className="credits-item credit-wiggle">
                                        <div className="overflow-wrapper">
                                            <span className="credits-label" style={{ color: '#8b5cf6', fontWeight: 700 }}>
                                                {m.role}
                                            </span>
                                        </div>
                                        <div className="overflow-wrapper">
                                            <span className="credits-name" data-wiggle-target="true" style={{ fontWeight: 800 }}>
                                                {m.name}
                                            </span>
                                        </div>
                                    </div>
                        ...
                        <a href="#" className="footer-credits">tim founder</a>
                    </div>
                </div>
            </div>
        </div>
