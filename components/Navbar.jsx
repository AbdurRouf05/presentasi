...
import KalibraLogo from '@/components/KalibraLogo';
...
export default function Navbar() {
    useEffect(() => {
        ...
        const updateNavbarColor = () => {
            if (!navbar) return;
            const probeY = navbar.offsetHeight / 2;

            // Toggle frosted background on scroll
            ...
            // Sections with dark / solid lavender background
            const darkSections = document.querySelectorAll('.vimeo-hero, #saas-erp, .service-cards-wrapper, #model-bisnis, #market-sizing, .main-footer');
        ...
        gsap.ticker.add(updateNavbarColor);
        updateNavbarColor();
        ...
        return () => {
            ...
            gsap.ticker.remove(updateNavbarColor);
            ...
            <nav className="navbar">
                <div className="nav-left" style={{ cursor: "url('/assets/Cursor SVG/cursor-pointer.svg') 12 12, pointer" }}>
                    <div className="nav-hover-trigger">
                        ...
                        {/* Pop-out Box for Left Side (Menu Navigasi Slide) */}
                        <div className="nav-popout nav-work-box">
                            <div className="nav-popout-inner">
                                <a href="#saas-erp" className="nav-work-item" style={{ textDecoration: 'none', color: 'inherit' }}>
                                    ...
                                    <div className="nav-work-item__text">
                                        <span className="nav-work-badge badge-pink">Fondasi Konsep</span>
                                        <h4 className="nav-work-title">Apa itu SaaS &amp; ERP?</h4>
                                    </div>
                                </a>
                                <a href="#masalah" className="nav-work-item" style={{ textDecoration: 'none', color: 'inherit' }}>
                                    <div className="nav-work-item__img-wrap" style={{ background: '#ffe4e6', color: '#e11d48' }}>
                                        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
                                    ...
                                    <div className="nav-work-item__text">
                                        <span className="nav-work-badge badge-maroon">Fakta Lapangan</span>
                                        <h4 className="nav-work-title">4 Masalah Nyata UMKM</h4>
                                    </div>
                                </a>
                                <a href="#solusi" className="nav-work-item" style={{ textDecoration: 'none', color: 'inherit' }}>
                                    <div className="nav-work-item__img-wrap" style={{ background: '#dcfce7', color: '#059669' }}>
                                        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
                                    ...
                                    <div className="nav-work-item__text">
                                        <span className="nav-work-badge badge-green">Inovasi Inti</span>
                                        <h4 className="nav-work-title">4 Solusi Kunci Kalibra</h4>
                                    </div>
                                </a>
                                <a href="#showreel-section" className="nav-work-item" style={{ textDecoration: 'none', color: 'inherit' }}>
                                    <div className="nav-work-item__img-wrap" style={{ background: '#fef3c7', color: '#d97706' }}>
                                        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
                                    ...
                                    <div className="nav-work-item__text">
                                        <span className="nav-work-badge badge-amber">Head-to-Head</span>
                                ...
                                <a href="#tim" className="nav-work-item" style={{ textDecoration: 'none', color: 'inherit' }}>
                                    ...
                                    <div className="nav-work-item__text">
                                        <span className="nav-work-badge badge-indigo">Tim Founder</span>
                                        <h4 className="nav-work-title">Anggota Tim &amp; Kontak</h4>
                                    </div>
                                </a>
                                <a href="#hero-section" className="nav-work-btn">
                                    <span className="nav-work-btn__text">Kembali ke Awal Slide ↑</span>
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div className="nav-center" style={{ cursor: "url('/assets/Cursor SVG/cursor-pointer.svg') 12 12, pointer" }}>
                    <div className="logo-truus" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                        <KalibraLogo size={27} showWordmark={true} />
                    </div>
                </div>
                <div className="nav-right" style={{ cursor: "url('/assets/Cursor SVG/cursor-pointer.svg') 12 12, pointer" }}>
                    <div className="nav-hover-trigger">
                        <div className="logo-whatsapp">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 25 27" fill="none" className="nav-bar__whatsapp-svg">
                        ...
                        <div className="nav-popout nav-wa-box">
                            <div className="nav-popout-inner">
                                ...
                                <h4 className="nav-wa-title">Chat Tim Founder</h4>
                                <p className="nav-wa-desc">Scan QR untuk diskusi kemitraan, pilot outlet, atau presentasi teknis produk.</p>
                                <a href="https://wa.me/6281234567890" target="_blank" rel="noopener noreferrer" className="nav-wa-link">
                                    <span className="nav-wa-link-text">Buka WhatsApp Langsung</span>
