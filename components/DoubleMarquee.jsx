        ...
        <>
            ...
            <div className="marquee-left">
                <div className="marquee-text-container">
                    <h2>keunggulan &amp;<br />fitur <span className="text-with">inti:</span></h2>
                    ...
                    <div key={colIndex} className="marquee-column">
                        <div className="marquee-track">
                            {trackItems.map((item, i) => (
                                <div key={i} className="marquee-item" data-brand={item.brand.name} style={{
                                    ...
                                    <div style={{
                                        ...
                                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2l2.4 7.2L22 12l-7.6 2.8L12 22l-2.4-7.2L2 12l7.6-2.8z" /></svg>
                                    </div>
                                    <span style={{
                                        fontSize: '0.72rem',
